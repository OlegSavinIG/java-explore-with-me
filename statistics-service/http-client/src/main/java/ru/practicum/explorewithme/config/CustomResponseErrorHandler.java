...
public class CustomResponseErrorHandler implements ResponseErrorHandler {
    ...
    public void handleError(ClientHttpResponse response) throws IOException {
        ...
        switch (response.getStatusCode()) {
            case BAD_REQUEST:
                throw new CustomBadRequestException("Bad request: " + response.getStatusText());
            case NOT_FOUND:
                throw new CustomNotFoundException("Not found: " + response.getStatusText());
            default:
                throw new CustomGenericException("Generic error: " + response.getStatusText());
        }
    }
}
